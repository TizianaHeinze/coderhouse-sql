...
-- Elimina la tabla inventario si ya existe.
-- Esto permite volver a ejecutar todo el script sin errores.
...
CREATE TABLE inventario (
    ...
    -- VARCHAR(100) permite almacenar nombres de productos de hasta 100 caracteres.
    nombre_producto VARCHAR(100),

    -- VARCHAR(50) permite almacenar el nombre de la categoría.
    categoria VARCHAR(50),

    -- DECIMAL(10,2) se utiliza para valores monetarios con dos decimales.
    precio_unitario DECIMAL(10,2),

    -- INT se utiliza porque el stock se expresa en unidades enteras.
    stock_actual INT,

    -- INT permite almacenar el mínimo de unidades necesarias antes de reponer.
    stock_minimo INT,

    -- DATE almacena solamente la fecha de ingreso, sin hora.
    fecha_ingreso DATE,

    -- TINYINT permite representar el estado del producto con 1 o 0.
    activo TINYINT
);
...
-- Ver la tabla completa para confirmar que los datos se cargaron correctamente.
